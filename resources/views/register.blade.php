...
<body>
    ...
    <p class="text-2xl text-gray-900 dark:text-white text-center font-bold m-10 p-10">Create Your Account Travelers!</p>

    <form class="max-w-md mx-auto mb-10" action="{{ route('auth.registers') }}" method="POST">
        @csrf
